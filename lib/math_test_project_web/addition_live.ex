defmodule MathTestProjectWeb.AdditionLive do
  @moduledoc """
  Standalone page where users enter two numbers and get their sum.

  This LiveView provides a form for adding two numbers and displays the result.
  """
  ...
  Parses the two numbers from the form, calls the Calculator.add/2 function,
  and assigns the result to the socket.
  """
  @spec handle_event(String.t(), map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  def handle_event("calculate", %{"addition" => params}, socket) do
  ...
  @doc """
  Renders the addition page with form and result display.
  """
  def render(assigns) do
    ~H"""
    <div class="mx-auto max-w-sm">
      <h1 class="text-2xl font-bold mb-4">Addition</h1>

      <form id="addition-form" phx-submit="calculate" class="space-y-4">
        <div>
